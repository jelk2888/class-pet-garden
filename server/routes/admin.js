...
import { registerAdminPetRoutes } from './pets.js'
import { registerAdminShopCatalogRoutes } from './shopCatalogAdmin.js'
...
registerAdminPetRoutes(router, authMiddleware, adminMiddleware)
registerAdminShopCatalogRoutes(router, authMiddleware, adminMiddleware)
